...
function makeWorkspace() {
  ...
  writeFileSync(
    ...
    `${JSON.stringify({ name: '@next-model/private-tool', version: '0.0.0', private: true }, null, 2)}\n`,
  );
  return root;
}
...
test('skips private packages', () => {
  ...
  try {
    ...
    const priv = JSON.parse(readFileSync(join(root, 'packages', 'private-tool', 'package.json'), 'utf8'));
